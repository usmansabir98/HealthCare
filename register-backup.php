      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div style="display: flex; justify-content: center" class="p-b-20">
            <div class="btn btn-outline btn-rounded btn-dark" style="width: 80%;" id="cancel-modal">Confirm</div>
          </div>
    ...
    <div id="login-page-details">
      ...
      <div id="form-buttons">
        <ul class="nav nav-pills justify-content-center mb-3" id="pills-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-hospital" role="tab" aria-controls="pills-home" aria-selected="true">Hospital</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-user" role="tab" aria-controls="pills-profile" aria-selected="false">User</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-retailer" role="tab" aria-controls="pills-contact" aria-selected="false">Retailer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-login" role="tab" aria-controls="pills-contact" aria-selected="false">Login</a>
          </li>
        </ul>        
      </div>

      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-hospital" role="tabpanel" aria-labelledby="pills-home-tab">
        ...
        <div class="tab-pane fade" id="pills-retailer" role="tabpanel" aria-labelledby="pills-contact-tab">
        ...
        <div class="tab-pane fade" id="pills-login" role="tabpanel" aria-labelledby="pills-contact-tab">
